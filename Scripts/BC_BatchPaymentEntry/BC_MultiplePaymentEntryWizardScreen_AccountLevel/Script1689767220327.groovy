...
WebUI.selectOptionByLabel(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/lst_PaymentInstrument'), PaymentInstrument, false, FailureHandling.CONTINUE_ON_FAILURE)
