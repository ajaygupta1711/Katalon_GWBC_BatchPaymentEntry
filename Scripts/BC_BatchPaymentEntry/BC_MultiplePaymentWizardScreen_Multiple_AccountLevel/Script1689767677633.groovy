...
WebUI.verifyElementVisible(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_Account'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_Account'), Account, FailureHandling.CONTINUE_ON_FAILURE)

/*// Payment on Agency Statement level

WebUI.verifyElementVisible(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_ABStatement'), FailureHandling.CONTINUE_ON_FAILURE)
WebUI.setText(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_ABStatement'), ABStatement, FailureHandling.CONTINUE_ON_FAILURE)
	
// Payment on DB commission on Agency level       
	
WebUI.verifyElementVisible(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/chk_DBCommissions'), FailureHandling.CONTINUE_ON_FAILURE)
WebUI.setText(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/chk_DBCommissions'), DBCommissions, FailureHandling.CONTINUE_ON_FAILURE)	
*/
...
// handle table rows and columns

TotalAmount = WebUI.getText(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/lbl_TotalAmount'))

WebUI.setText(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_BatchAmount'), TotalAmount)
