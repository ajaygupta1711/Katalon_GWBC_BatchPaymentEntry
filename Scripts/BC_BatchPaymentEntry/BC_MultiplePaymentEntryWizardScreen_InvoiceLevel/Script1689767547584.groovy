...
WebUI.verifyElementVisible(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_Invoice'), FailureHandling.CONTINUE_ON_FAILURE)
	
WebUI.setText(findTestObject('pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_Invoice'), Invoice, FailureHandling.CONTINUE_ON_FAILURE)
