...
WebUI.verifyElementVisible(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_Account'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_Account'), Account)
