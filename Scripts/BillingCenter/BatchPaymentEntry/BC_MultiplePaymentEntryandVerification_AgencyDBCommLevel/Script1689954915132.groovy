...
WebUI.verifyElementVisible(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_AgencyCode'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_AgencyCode'), AgencyCode)

WebUI.sendKeys(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_MultiplePaymentWizard/txt_AgencyCode'), Keys.chord(
        Keys.TAB))

WebUI.verifyElementVisible(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_MultiplePaymentWizard/chk_DBCommissions'))

WebUI.check(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_MultiplePaymentWizard/chk_DBCommissions'))

WebUI.verifyElementChecked(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_MultiplePaymentWizard/chk_DBCommissions'), 
    0)
...
// String BatchNumber = WebUI.getText(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_MultiplePaymentWizard/val_BatchNumber'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_Verify_PostedPayments/option_TransactionsProducer'))

WebUI.click(findTestObject('BillingCenter/pge_BatchPaymentEntry/screen_Verify_PostedPayments/Tab_PaymentsProducer'))

WebDriver driver = DriverFactory.getWebDriver()

WebElement Table = driver.findElement(By.xpath('//*[@id=\'ProducerTransactions-ProducerTransactionsScreen-PaymentsLV\']//tbody'))

List<String> elementsinColumn = CustomKeywords.'gw.Table.getTableElementsByColumn'(Table, 7)
...
if (elementsinColumn.contains(CheckRef)) {
    KeywordUtil.markPassed('Agency DB Commission Payment CheckRef Found')
} else {
    KeywordUtil.markFailed('Agency DB Commission Payment CheckRef NOT Found')
}
