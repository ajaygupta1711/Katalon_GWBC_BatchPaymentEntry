...
//CustomKeywords.'gw.Actions.NavigateByActions'('New Shared Activity;New Shared Activity;Reminder;Reminder;notification')

CustomKeywords.'gw.Actions.Click'(findTestObject("Common/pge_Common/wel_Actions"))
	
WebUI.mouseOver(findTestObject('BillingCenter/pge_NewActivity/lnk_NewSharedActivity'))

WebUI.mouseOver(findTestObject('BillingCenter/pge_NewActivity/lnk_Reminder'))


CustomKeywords.'gw.Actions.Click'(findTestObject('BillingCenter/pge_NewActivity/lnk_Notification'))

//CustomKeywords.'gw.Actions.click'(findTestObject('BillingCenter/pge_NewActivity/lnk_Reminder'))
