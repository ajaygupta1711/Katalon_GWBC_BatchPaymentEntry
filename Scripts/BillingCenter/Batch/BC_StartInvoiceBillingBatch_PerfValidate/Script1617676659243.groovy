...
KeywordUtil.saveInfo("BC_StartInvoiceBillingbatch: ")
...
WebUI.click(findTestObject('BillingCenter/Batch/pge_BatchPage/div_RunInvoiceBillingBatch'))

WebUI.waitForPageLoad(GlobalVariable.gWaitTimeOut)

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/BillingCenter/Batch/pge_BatchPage/div_BillingInvoiceDownLoad'))
