...
KeywordUtil.saveInfo("BC_StartDBCommissionStatementTrigger: ")
...
WebUI.click(findTestObject('BillingCenter/Batch/pge_BatchPage/div_RunDBCommissionStatementTrigger'))

//WebUI.waitForPageLoad(GlobalVariable.gWaitTimeOut)

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/BillingCenter/Batch/pge_BatchPage/div_DBCommissionStatementTriggerDownLoad'))
