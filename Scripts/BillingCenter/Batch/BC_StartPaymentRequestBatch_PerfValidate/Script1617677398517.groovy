...
KeywordUtil.saveInfo("BC_StartPaymentRequestBatch: ")
...
WebUI.click(findTestObject('BillingCenter/Batch/pge_BatchPage/div_RunPaymentRequestBatch'))

WebUI.waitForPageLoad(GlobalVariable.gWaitTimeOut)

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/BillingCenter/Batch/pge_BatchPage/div_PaymentRequestDownLoad'))
