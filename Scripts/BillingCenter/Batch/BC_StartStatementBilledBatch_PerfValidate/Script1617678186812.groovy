...
KeywordUtil.saveInfo("BC_StartStatementBilledBatch: ")
...
WebUI.click(findTestObject('BillingCenter/Batch/pge_BatchPage/div_RunStatementBilledBatch'))

WebUI.waitForPageLoad(GlobalVariable.gWaitTimeOut)

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/BillingCenter/Batch/pge_BatchPage/div_StatementBilledDownLoad'))
