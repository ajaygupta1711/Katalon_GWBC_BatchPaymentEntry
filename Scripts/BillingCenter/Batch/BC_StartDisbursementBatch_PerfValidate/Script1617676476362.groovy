...
KeywordUtil.saveInfo("BC_StartDisbursementBatch: ")
...
WebUI.click(findTestObject('BillingCenter/Batch/pge_BatchPage/div_RunDisbursementBatch'))

WebUI.waitForPageLoad(GlobalVariable.gWaitTimeOut)

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/BillingCenter/Batch/pge_BatchPage/div_DisbursementsBatchDownLoad'))
