...
KeywordUtil.saveInfo("BC_StartInvoiceDocumentTrigger: ")
...
WebUI.click(findTestObject('BillingCenter/Batch/pge_BatchPage/div_RunInvoiceDocumentTrigger'))

WebUI.waitForPageLoad(GlobalVariable.gWaitTimeOut)

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/BillingCenter/Batch/pge_BatchPage/div_InvoiceDocumentTriggerDownLoad'))
