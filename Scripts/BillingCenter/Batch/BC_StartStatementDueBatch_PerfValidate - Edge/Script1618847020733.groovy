...
KeywordUtil.saveInfo("BC_StartStatementDueBatch: ")
...
WebUI.click(findTestObject('BillingCenter/Batch/pge_BatchPage/div_RunStatementDueBatch'))

WebUI.waitForPageLoad(GlobalVariable.gWaitTimeOut)

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/BillingCenter/Batch/pge_BatchPage/div_StatementDueBatchDownLoad'))
